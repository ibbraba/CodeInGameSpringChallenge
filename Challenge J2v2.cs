...
public class Situation
{
        ...
        if(spiderNumber == 0 ){
            ...
            //Kill Spider threatning
            if(threatNumber == 1 ){

                if(threatSpiders[0].posX < 7000 && threatSpiders[0].posY < 5000){
                Console.WriteLine("MOVE " + threatSpiders[0].posX + " " + threatSpiders[0].posY);
                Console.WriteLine("MOVE " + threatSpiders[0].posX + " " + threatSpiders[0].posY);
                Console.WriteLine("WAIT");
                }else{
                        for(int i=0; i<3; i++){
...
class Player
{
    static void Main(string[] args)
    {
        ...
        List <Spider> threatSpiders = new List<Spider>();
            ...
            Console.Error.WriteLine(threatSpiders.Count);
...
// Create Scenarios and associate it with Actionsusing System;
using System.Linq;
using System.IO;
using System.Text;
using System.Collections;
